...
public class ChequeBordService {
	 ...
	 @Autowired
	    ...
	    @Autowired
	    public ChequeBordService(ChequeRepository Repo,BordereauRepository RepoB,BanqueRepo Repobanque,ClientRepo Repoclient,CompteRepo repocompte,AgenceRepository AgenceRepo, FilesStorageService filesStorageService) {
	        this.repoC = Repo;
	        this.repoB=RepoB;
...
//suivie
	  ...
	  //adminClient
	    ...
	    public Client RechercherClient(Long id ) {
  	    ...
  	    public ResponseEntity<Resource> downloadChequeImg(String fileName, HttpServletRequest request) {
  	        // Load file as Resource
  	        Resource resource = filesStorageService.loadResource(fileName);
